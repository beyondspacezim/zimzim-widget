...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Pi(){return new Kr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ii(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fi(){return new Kr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ii(),fragmentShader:`
